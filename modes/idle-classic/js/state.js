...
const IDLE_HEROES = [
  ...
  ,{id:'paladin', name:'Aldric', title:'Paladin', portrait:'assets/sprites/Characters/craftpix/Paladin/Idle/0_Paladin_Idle_000.png', position:null, base:{hp:142,power:10,armor:13,crit:2,precision:3}, spell:{name:'Bénédiction du bouclier', type:'heal', multiplier:.20, cooldownTurns:4, castAnimation:'spell', vfx:'blessed', vfxBasePath:'assets/sprites/Characters/craftpix/Paladin/Blessed', vfxFramePrefix:'0_Paladin_Blessed_', vfxFramePadding:3, vfxFrames:30, icon:'Shield-blessed/Blessed.png'}}
  ,{id:'ninja', name:'Kaito', title:'Ninja blanc', portrait:'assets/sprites/Characters/craftpix/White Ninja/Idle/Idle_000.png', position:null, base:{hp:96,power:16,armor:5,crit:8,precision:12}, spell:{name:'Nuage toxique', type:'aoe', multiplier:1.25, cooldownTurns:3, castAnimation:'spell', vfx:'poisonous-smoke', vfxBasePath:'assets/sprites/Characters/craftpix/White Ninja/Poisonous Smoke', vfxFramePrefix:'Poisonous Smoke', vfxFrameStart:1, vfxFrames:12, icon:'Icons/PNG/Posionous Smoke.png', impactFrame:5, impactColor:'arcane'}}
];
